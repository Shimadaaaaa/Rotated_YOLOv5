...
if __name__ == '__main__':
    ...
    boxes = np.array([[100, 100, 20 , 100, 0.5, 0.5, 0.5, 0.5, 0.8],
                      [101, 101, 20 , 100, 0.5, 0.5, 0.5, 0.5, 0.7],
                      [100, 100, 100, 100, 0.9, 0.9, 0.9, 0.9, 0.8],
                      [200, 200, 100, 100, 0.5, 0.5, 0.5, 0.5, 0.8]],dtype=np.float32)
